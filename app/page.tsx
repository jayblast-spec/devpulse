...
const product = {"repo":"DevPulse","suite":"Creator / Founder Tools","category":"Developer signal","audience":"developers, indie hackers, CTOs, and technical creators","promise":"turn code, commits, and product motion into a public proof engine","inputLabel":"Project update, repo summary, or changelog","placeholder":"Added live SSE cockpit, failure learning, and repo factory quality gate","primary":"Generate dev pulse","gradient":"from-cyan-300 via-emerald-300 to-lime-300","metrics":["Build log","Proof feed","Credibility score"],"modules":["Changelog intelligence","Technical story builder","Repo health pulse","Demo script","Public proof archive"],"outputs":["Public update","Technical summary","Next demo target","Credibility gaps"],"pricing":"Free pulse, $19/month Builder, $99/month Team proof hub."} as const;
